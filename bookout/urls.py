...
# Initiates connection process after a user clicks on another user's invitation link
app.add_url_rule('/connect/<otherUserID>', view_func=views.send_connection_request)
